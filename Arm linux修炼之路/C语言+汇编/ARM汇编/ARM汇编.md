...
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/Untitled Database/Untitled\|Untitled]]|||
...
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/单寄存器的Load Store 指令/Untitled\|Untitled]]||||
...
|指令|描述|指令系统|
|---|---|---|
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/多寄存器内存字段数据传送指令/LDM\|LDM]]|装载多个寄存器|LDM{<cond>}<addressing_mode> <Rn>{!},<registers>|
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/多寄存器内存字段数据传送指令/STM\|STM]]|保存多个寄存器|STM{<cond>}<addressing_mode> <Rn>{!},<registers>|
...
|指令|描述|指令系统|
|---|---|---|
|[[LDM]]|装载多个寄存器|LDM{<cond>}<addressing_mode> <Rn>{!},<registers_without_pc>|
|[[STM]]|保存多个寄存器|STM{<cond>}<addressing_mode> <Rn>{!},<registers>^|
...
|指令|描述|指令系统|
|---|---|---|
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/带状态寄存器的多寄存器内存字段数据传送指令/LDM\|LDM]]|装载多个寄存器|LDM{<cond>}<addressing_mode> <Rn>{!},<registers_without_pc>|
...
|[[Arm linux修炼之路/C语言+汇编/ARM汇编/乘法指令/Untitled\|Untitled]]|||||
